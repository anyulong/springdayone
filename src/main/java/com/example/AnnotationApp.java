...
//		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(AppConfig.class);
		...
		context.scan("com.example");//指定查找bean的包,带有@Component标签的或者标签里面有@Component标签的java文件
		context.refresh();
...
//		}
		AutoIn autoIn = context.getBean(AutoIn.class);
		System.out.println(autoIn);
		
		ComplexObject moreComplexObject = (ComplexObject) context.getBean("ComplexObject");
